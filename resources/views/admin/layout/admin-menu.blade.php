<div class="admin-menu">
	<ul>
		...
		<li class="dash">
			<a href="javascript:;">
				<svg class="bi bi-gear-wide-connected" width="1em" height="1em" viewBox="0 0 20 20" fill="currentColor"
		...
		<li class="article">
			<a href="javascript:;">
				<svg class="bi bi-book-half-fill" width="1em" height="1em" viewBox="0 0 20 20" fill="currentColor"
					xmlns="http://www.w3.org/2000/svg">
					<path fill-rule="evenodd"
