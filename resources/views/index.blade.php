				...
				<div class="col-md-5 video-box">
					<div id="38930755627">
						<script type="text/JavaScript"
							src="https://www.aparat.com/embed/uhoCS?data[rnddiv]=38930755627&data[responsive]=yes">
						</script>
					</div>
				</div>
		...
		<div class="col-md-12">
			<div class="container">
				<article class="post">
					...
					<div class="clearfix"></div>
					<div class="post-txt">
						<h4>اگر با وردپرس کار می کنید و سایت وردپرسی دارید حتما باید با ساختار اولیه فایل ها و پوشه
							های
							...</h4>
					</div>
				...
				<article class="post">
					...
					<div class="clearfix"></div>
					<div class="post-txt">
						<h4>چگونه سایت بسازیم؟ این سوالی است که در ابتدای کار شاید کمی سخت و پیچیده بنظر برسد یا
							شاید با
							...</h4>
					</div>
					<div class="post-foot-container">
				...
				<article class="post">
					...
					<div class="post-title">
						<h2><a target="_blank" href="/single/4" dideo-checked="true">آموزش نصب بسته نصبی آسان
								وردپرس</a>
						</h2>
					</div>
					<div class="clearfix"></div>
					<div class="post-txt">
						<h4>نصب بسته نصبی آسان در وردپرس یکی از کاربردی ترین امکاناتی از است که توسط افزونه
							duplicator
							فراهم شده، اگر ...</h4>
					</div>
					<div class="post-foot-container">
				...
				<article class="post">
					...
					<div class="post-title">
						<h2><a target="_blank" href="/single/4" dideo-checked="true">آموزش ساخت اسلایدر با
								افزونه</a>
						</h2>
					</div>
					<div class="clearfix"></div>
