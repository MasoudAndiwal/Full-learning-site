				...
				<form class="my-form" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-md-9">
							...
							<br>
							<textarea class="form-control" name="body" id="body" aria-hidden="true" rows="12">
							...
							<div class="box-widget">
								...
								<div class="custom-control custom-checkbox">
									<div class="boxcheck">
										...
										<div class="custom-control custom-checkbox ">
											<div class="boxcheck">
												<svg class="bi bi-arrow-return-left" width="1em" height="1em"
												...
												<label class="custom-control-label" for="14">فیلم</label>
											</div>
										</div>
									...
									<div class="boxcheck">
										...
										<div class="custom-control custom-checkbox ">
											<div class="boxcheck">
												...
												<label class="custom-control-label" for="22">پایتون</label>
											</div>
										</div>
								...
								<div class="custom-control custom-checkbox">
									<div class="boxcheck">
										<input name="cat[]" value="23" type="checkbox" class="custom-control-input"
											id="23">
